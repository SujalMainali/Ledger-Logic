...
void EditWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->PopulateSelectHeader(); break;
        case 1: _t->on_Cancel_clicked(); break;
        case 2: _t->on_Save_clicked(); break;
        case 3: { int16_t _r = _t->GetTypeIdFromType((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])));
